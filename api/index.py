...
@app.route('/')
def home():
    return jsonify({"status": "ok", "message": "✅ Quizizz API running on Vercel!"})
...
Chỉ phản hồi JSON duy nhất dạng:
[{{"question":"...","answer":"..."}}]
Dữ liệu:
{all_data}
'''
...
# Đoạn này rất quan trọng cho Vercel
def handler(event, context):
    from werkzeug.middleware.dispatcher import DispatcherMiddleware
    from werkzeug.wrappers import Response
    return DispatcherMiddleware(app, {"/": app})(event, context)